...
def render_cfa_login():
    """
    Renderiza la Landing Page oficial con:
    ...
    with col_center:
        ...
        st.markdown("""
        <div style="text-align: center; margin-top: 22px; font-size: 11.5px; color: rgba(255,255,255,0.85); font-weight: 500; text-shadow: 0 1px 3px rgba(0,0,0,0.3);">
